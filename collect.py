...
def register_launch_arguments():
    ...
    parser.add_argument('--startBook', help='start book index', type=int,
                        choices=list(range(1, DevConfig.BOOKS_PER_PAGE + 1)),
                        default=1)
    parser.add_argument('--endBook', help='end book index', type=int,
                        choices=list(range(1, DevConfig.BOOKS_PER_PAGE + 1)),
                        default=DevConfig.BOOKS_PER_PAGE)
